...
class TestCoppModule(unittest.TestCase):
    ...
    def test_custom_trap_with_default_grp(self):
        ...
        print(returned)
        expect = display_template(dbs=["CONFIG_FILE", "CONFIG_DB", "APPL_DB", "ASIC_DB", "STATE_DB"])
    ...
    def test_custom_trap_with_missing_group(self):
        ...
        returned = m_copp.execute(params)
        print(returned)
        expect = display_template(dbs=["CONFIG_DB", "APPL_DB", "ASIC_DB", "STATE_DB", "CONFIG_FILE"])
    ...
    def test_missing_state(self):
        ...
        returned = m_copp.execute(params)
        print(returned)
        expect = display_template(dbs=["CONFIG_FILE", "APPL_DB", "ASIC_DB", "STATE_DB","CONFIG_DB"])
